document.addEventListener('DOMContentLoaded', function() {
    ...
    function isBusinessRelated(message) {
        ...
        // Check if message contains any business-related keywords
        const hasBusinessKeyword = businessKeywords.some(keyword => lowerMessage.includes(keyword));
        
        // If there's a business keyword, allow the message
        if (hasBusinessKeyword) {
            return true;
        }
        
        // If no business keyword, check if it's just a simple conversational word
